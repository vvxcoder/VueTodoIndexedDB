<template>
  <form @submit.prevent="submit" class="flex flex-wrap justify-between sm:justify-center">
    ...
    <div class="flex flex-grow sm:ml-4" :class="{ 'sm:flex-grow-0': populateWith.empty }">
      <button
        type="submit"
        title="save"
      ...
      >{{ populateWith.empty ? '+' : 'Save' }}</button>
